...
export interface ArticleContent { answer: string; sections: ArticleSection[]; }

export const articleContent: Record<string, ArticleContent> = {
  'dating-without-swiping': {
    answer: 'Dating without swiping means creating opportunities to get to know someone beyond a quick profile decision. Shared activities, introductions and conversation-led formats offer different ways to start. The useful question is what happens after the introduction.',
    sections: [
      {
        id: 'different-ways', title: 'Start with the kind of interaction you enjoy',
        paragraphs: [
      ...
      {
        id: 'compare-experiences', title: 'Five questions to ask before joining',
        paragraphs: ['A different interface is only one part of the experience. Before committing your time, look for clear answers to these questions:'],
        points: [
      ...
      {
        id: 'try-a-conversation', title: 'Give the conversation something to work with',
        paragraphs: [
      ...
      {
        id: 'safety', title: 'Keep safety part of the decision',
        paragraphs: [
        ...
        source: { label: 'Read eSafety’s online dating guide', url: 'https://www.esafety.gov.au/key-topics/staying-safe/online-dating' },
      },
      {
        id: 'rosemarry', title: 'Where Rosemarry fits',
        paragraphs: [
  ...
  'endless-swiping': {
    answer: 'An endless stream of profiles can make dating feel like a sequence of decisions rather than a chance to know someone. Research suggests that repeated choices can encourage rejection in some online-dating settings. It does not mean that every person has the same experience.',
    sections: [
      {
        id: 'what-profiles-miss', title: 'What a profile can show',
        paragraphs: [
      ...
      {
        id: 'research', title: 'What choice-overload research found',
        paragraphs: [
        ...
        source: { label: 'Pronk & Denissen: A Rejection Mind-Set (2020)', url: 'https://doi.org/10.1177/1948550619866189' },
      },
      {
        id: 'change-the-session', title: 'Try one change to your next session',
        paragraphs: [
      ...
      {
        id: 'more-context', title: 'Look for opportunities to build context',
        paragraphs: [
  ...
  'dating-app-fatigue': {
    answer: 'If dating apps feel like another task to manage, it can help to reduce the number of conversations, set a stopping point and take a break when you want one. “Dating app fatigue” describes an experience people talk about; this guide is about everyday habits, not a diagnosis.',
    sections: [
      {
        id: 'notice-the-friction', title: 'Identify the part that takes your energy',
        paragraphs: [
      ...
      {
        id: 'boundaries', title: 'Make a smaller commitment',
        paragraphs: [
      ...
      {
        id: 'other-connections', title: 'Keep space for the rest of your social life',
        paragraphs: [
        ...
        source: { label: 'Practical online dating safety guidance from eSafety', url: 'https://www.esafety.gov.au/key-topics/staying-safe/online-dating' },
      },
      {
        id: 'different-pace', title: 'Choose a format that fits your attention',
        paragraphs: [
  ...
  'attraction-over-time': {
    answer: 'Attraction can change as you get to know someone, but it does not always grow. Another conversation may give you more information if you feel curious and comfortable. You never owe someone continued attention in the hope that a spark will appear.',
    sections: [
      {
        id: 'first-impressions', title: 'A first impression is a starting point',
        paragraphs: [
      ...
      {
        id: 'research', title: 'What research can tell us',
        paragraphs: [
        ...
        source: { label: 'Hunt, Eastwick & Finkel: Leveling the Playing Field (2015)', url: 'https://doi.org/10.1177/0956797615579273' },
      },
      {
        id: 'notice', title: 'Look for curiosity, ease and reciprocity',
        paragraphs: [
      ...
      {
        id: 'no-deadline', title: 'There is no deadline for a spark',
        paragraphs: [
